...
public class TriangleScript : MonoBehaviour, ISpawnedObject
{
    public void OnSpawned(string[] args, object sender)
    {
        ...
        GetComponent<SpriteRenderer>().color = new Color32(255, 32, 113, byte.Parse(args[5]));
        GetComponent<BoxCollider2D>().enabled = bool.Parse(args[6]);
    }
}
